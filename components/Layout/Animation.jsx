        ...
        <g className="m1_stage" opacity={0}>
          ...
          <g className="m1_cGroup">
            ...
            <g className="m1Orb orb3c">
              <image
                xlinkHref="https://assets.codepen.io/721952/logoAngular.png"
                width={40}
                height={40}
              />
            </g>
            <g className="m1Orb orb3b">
              <image
                xlinkHref="https://assets.codepen.io/721952/logoReact.png"
                width={40}
                height={40}
              />
            </g>
            <g className="m1Orb orb3">
              <circle cx={20} cy={8} r={24} stroke="#bc7c00" strokeWidth={3} fill="#cc971b" />
              <path
                fill="#fff"
                opacity="0.7"
          ...
          <g className="m1_cGroup">
            ...
            <g className="m1Orb orb2">
              <circle cx="18.5" cy={7} r="24.5" fill="#983334" strokeWidth="2.5" stroke="#b9393a" />
              <path
                fill="#fff"
                opacity="0.7"
